<form method="POST" action="{{route('book.edit')}}" >
  ...
  <input type="textbox"  class="form-control" name="number_of_copies" value="{{$book_info->number_of_copies}}">
  <br><label> Number of Borrows: </label>
  <input type="textbox"  class="form-control" readonly value="{{$book_info->borrows}}">
