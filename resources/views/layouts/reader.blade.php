                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (auth()->guard('reader')->guest())
                          <li><a href="{{ url('/reader/login') }}">Login</a></li>
                          <li><a href="{{ url('/reader/register') }}">Register</a></li>
                        @else
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="{{url('/')}}/reader/profile/{{ auth()->guard('reader')->user()->id }}"><span class="fa fa-user"></span> Profile</a>
                                        <a href="{{ url('/reader/logout') }}"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                            <span class="fa fa-sign-out"></span> Logout
                                        </a>

                                        <form id="logout-form" action="{{ url('/reader/logout') }}" method="POST" style="display: none;">
                                            {{ csrf_field() }}
                                        </form>
                                    </li>
                                </ul>
